 ...
 * </copyright>
 *
 * $Id: CollaborationDiagramImpl.java,v 1.2 2008/05/23 05:15:13 dxm Exp $
 */
...
public class CollaborationDiagramImpl extends EObjectImpl implements CollaborationDiagram {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.COLLABORATION_DIAGRAM__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.COLLABORATION_DIAGRAM__DESCRIPTION, oldDescription, description));
	}
