 ...
 * </copyright>
 *
 * $Id: BridgeImpl.java,v 1.2 2008/05/23 05:15:13 dxm Exp $
 */
...
public class BridgeImpl extends EObjectImpl implements Bridge {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.BRIDGE__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.BRIDGE__DESCRIPTION, oldDescription, description));
	}
	...
	public Domain getADomain() {
		if (aDomain != null && aDomain.eIsProxy()) {
			...
			if (aDomain != oldADomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.BRIDGE__ADOMAIN, oldADomain, aDomain));
			}
		}
		return aDomain;
	}
	...
	public void setADomain(Domain newADomain) {
		...
		aDomain = newADomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.BRIDGE__ADOMAIN, oldADomain, aDomain));
	}
	...
	public Domain getBDomain() {
		if (bDomain != null && bDomain.eIsProxy()) {
			...
			if (bDomain != oldBDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DomainPackage.BRIDGE__BDOMAIN, oldBDomain, bDomain));
			}
		}
		return bDomain;
	}
	...
	public void setBDomain(Domain newBDomain) {
		...
		bDomain = newBDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.BRIDGE__BDOMAIN, oldBDomain, bDomain));
	}
