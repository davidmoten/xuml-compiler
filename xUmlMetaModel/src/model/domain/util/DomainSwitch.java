 ...
 * </copyright>
 *
 * $Id: DomainSwitch.java,v 1.2 2008/05/23 05:15:19 dxm Exp $
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DomainPackage.DOMAIN: {
				...
				if (result == null) result = caseNamed(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DomainPackage.BRIDGE: {
				Bridge bridge = (Bridge)theEObject;
				T result = caseBridge(bridge);
				if (result == null) result = caseNamed(bridge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
