	...
	function createOptions() {
		$("body").prepend("<div id='options-editor' class='options-editor' title='Options'><input id='restoreOnLoad' type='checkbox' name='restoreOnLoad' value='false'> Restore on load</div>");
		$("body").prepend("<div id='options' class='options noprint'>Options</div>");
		var options = $("#options");
		var optionsEditor = $("#options-editor");	
		optionsEditor.dialog({ autoOpen: false });
		...
		if (localStorage.getItem("restoreOnLoad") == "true") {
			restore();
	...
	function makeDraggable() {
		var dragListener = {
				start: function() { repaint();},
				drag: function() { repaint();},
