...
import xuml.tools.jaxb.compiler.CodeGeneratorJavaOld.AttributeInfo;

import com.google.common.collect.Lists;
import com.google.common.collect.Sets;

public class ClassWriterOld {
	private String pkg;
	...
	public ClassWriterOld(PersistenceDetails persistence) {
		this.persistence = persistence;
	}

	public ClassWriterOld setClassName(String s) {
		className = s;
		return this;
	}

	public ClassWriterOld addClassAnnotation(String s) {
		classAnnotations.add(s);
		return this;
	}

	public ClassWriterOld addMember(String name, Type type, boolean addSetter,
	...
	public ClassWriterOld addType(Type type) {
		types.addType(type);
		return this;
	}
