	...
	private List<KeyMap> getAssociationsList(model.Class cls) {
		...
		if (cls instanceof Specialization) {
			...
			for (SpecializationGroup group : sp.getGroup()) {
				...
				a.setName(sp.getName() + " specialization of "
						+ group.getName());
				a.setDescription("specialization-generalization relationship");
				AssociationEndPrimary ae1 = ModelFactory.eINSTANCE
						.createAssociationEndPrimary();
				ae1.setClass(sp);
				ae1.setMandatory(false);
				ae1.setMultiple(false);
				ae1.setRole(sp.getName());
				ae1.setVerbClause("is specialized by");
				ae1.setDescription("generated by specialization instance");
				ae1.setAssociation(a);

				AssociationEndSecondary ae2 = ModelFactory.eINSTANCE
						.createAssociationEndSecondary();
				ae2.setClass(group.getGeneralization());
				ae2.setMandatory(true);
				ae2.setMultiple(false);
				ae2.setRole(group.getGeneralization().getName());
				ae2.setVerbClause("is generalized by");
				ae2.setDescription("generated by specialization instance");
