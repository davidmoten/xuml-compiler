...
public class SystemBase implements CodeGenerator {
	 ...
	 * and potentially by a sequence. Craft Tracking System used generated by a
	 * sequence but not sure how it worked exactly.
	 * 
	 * @param a
	 * @param generated
	...
	private AttributePersistence createIdentifierPrimary(Attribute a,
		...
		if (generated) {
			...
			// TODO these two statements appear mutually exclusive, I assume
			// they're in because of ecore limitations (or my limited knowledge
			// of ecore!)
