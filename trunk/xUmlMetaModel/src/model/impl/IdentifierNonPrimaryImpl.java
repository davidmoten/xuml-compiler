 ...
 * </copyright>
 *
 * $Id: IdentifierNonPrimaryImpl.java,v 1.4 2008/06/11 07:28:45 dxm Exp $
 */
package model.impl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Identifier Non Primary</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class IdentifierNonPrimaryImpl extends EObjectImpl implements IdentifierNonPrimary {
	/**
	 ...
	 * @generated
	 */
	protected IdentifierNonPrimaryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.IDENTIFIER_NON_PRIMARY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.IDENTIFIER_NON_PRIMARY__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.IDENTIFIER_NON_PRIMARY__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectWithInverseResolvingEList.ManyInverse<Attribute>(Attribute.class, this, ModelPackage.IDENTIFIER_NON_PRIMARY__ATTRIBUTE, ModelPackage.ATTRIBUTE__IDENTIFIER_NON_PRIMARY);
		}
		return attribute;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.IDENTIFIER_NON_PRIMARY__NAME:
				return getName();
			case ModelPackage.IDENTIFIER_NON_PRIMARY__DESCRIPTION:
