 ...
 * </copyright>
 *
 * $Id: AttributeDerivedImpl.java,v 1.2 2008/05/23 05:15:17 dxm Exp $
 */
package model.impl;
 ...
 * <ul>
 *   <li>{@link model.impl.AttributeDerivedImpl#getName <em>Name</em>}</li>
 *   <li>{@link model.impl.AttributeDerivedImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link model.impl.AttributeDerivedImpl#getAssociationEnd <em>Association End</em>}</li>
 *   <li>{@link model.impl.AttributeDerivedImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link model.impl.AttributeDerivedImpl#getIdentifierPrimary <em>Identifier Primary</em>}</li>
 *   <li>{@link model.impl.AttributeDerivedImpl#getIdentifierNonPrimary <em>Identifier Non Primary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeDerivedImpl extends EObjectImpl implements AttributeDerived {
	/**
	 ...
	 * @generated
	 */
	protected AttributeDerivedImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ATTRIBUTE_DERIVED;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ATTRIBUTE_DERIVED__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ATTRIBUTE_DERIVED__DESCRIPTION, oldDescription, description));
	}
	...
	public AssociationEnd getAssociationEnd() {
		if (associationEnd != null && associationEnd.eIsProxy()) {
			...
			if (associationEnd != oldAssociationEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.ATTRIBUTE_DERIVED__ASSOCIATION_END, oldAssociationEnd, associationEnd));
			}
		}
	...
	public NotificationChain basicSetAssociationEnd(AssociationEnd newAssociationEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ATTRIBUTE_DERIVED__ASSOCIATION_END, oldAssociationEnd, newAssociationEnd);
	...
	public void setAssociationEnd(AssociationEnd newAssociationEnd) {
		if (newAssociationEnd != associationEnd) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ATTRIBUTE_DERIVED__ASSOCIATION_END, newAssociationEnd, newAssociationEnd));
	}
	...
	public model.Class getClass_() {
		if (eContainerFeatureID != ModelPackage.ATTRIBUTE_DERIVED__CLASS) return null;
	...
	public NotificationChain basicSetClass(model.Class newClass, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newClass, ModelPackage.ATTRIBUTE_DERIVED__CLASS, msgs);
		return msgs;
	}
	...
	public void setClass(model.Class newClass) {
		if (newClass != eInternalContainer() || (eContainerFeatureID != ModelPackage.ATTRIBUTE_DERIVED__CLASS && newClass != null)) {
			...
			if (newClass != null)
				msgs = ((InternalEObject)newClass).eInverseAdd(this, ModelPackage.CLASS__ATTRIBUTE_DERIVED, model.Class.class, msgs);
			msgs = basicSetClass(newClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ATTRIBUTE_DERIVED__CLASS, newClass, newClass));
	}
	...
	public EList<IdentifierPrimary> getIdentifierPrimary() {
		if (identifierPrimary == null) {
			identifierPrimary = new EObjectWithInverseResolvingEList.ManyInverse<IdentifierPrimary>(IdentifierPrimary.class, this, ModelPackage.ATTRIBUTE_DERIVED__IDENTIFIER_PRIMARY, ModelPackage.IDENTIFIER_PRIMARY__DERIVED_ATTRIBUTE);
		}
	...
	public EList<IdentifierNonPrimary> getIdentifierNonPrimary() {
		if (identifierNonPrimary == null) {
			identifierNonPrimary = new EObjectWithInverseResolvingEList.ManyInverse<IdentifierNonPrimary>(IdentifierNonPrimary.class, this, ModelPackage.ATTRIBUTE_DERIVED__IDENTIFIER_NON_PRIMARY, ModelPackage.IDENTIFIER_NON_PRIMARY__DERIVED_ATTRIBUTE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ATTRIBUTE_DERIVED__ASSOCIATION_END:
				if (associationEnd != null)
					msgs = ((InternalEObject)associationEnd).eInverseRemove(this, ModelPackage.ASSOCIATION_END__DERIVED_ATTRIBUTE, AssociationEnd.class, msgs);
				return basicSetAssociationEnd((AssociationEnd)otherEnd, msgs);
			case ModelPackage.ATTRIBUTE_DERIVED__CLASS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetClass((model.Class)otherEnd, msgs);
			case ModelPackage.ATTRIBUTE_DERIVED__IDENTIFIER_PRIMARY:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIdentifierPrimary()).basicAdd(otherEnd, msgs);
			case ModelPackage.ATTRIBUTE_DERIVED__IDENTIFIER_NON_PRIMARY:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case ModelPackage.ATTRIBUTE_DERIVED__CLASS:
				return eInternalContainer().eInverseRemove(this, ModelPackage.CLASS__ATTRIBUTE_DERIVED, model.Class.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.ATTRIBUTE_DERIVED__NAME:
				return getName();
			case ModelPackage.ATTRIBUTE_DERIVED__DESCRIPTION:
