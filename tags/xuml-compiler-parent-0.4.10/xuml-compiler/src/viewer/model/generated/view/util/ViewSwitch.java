 ...
 * </copyright>
 *
 * $Id: ViewSwitch.java,v 1.1 2008/06/18 06:18:14 dxm Exp $
 */
package view.util;
...
public class ViewSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseLocation(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.DIMENSION: {
				Dimension dimension = (Dimension)theEObject;
				T result = caseDimension(dimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.FRAME: {
				Frame frame = (Frame)theEObject;
				T result = caseFrame(frame);
				if (result == null) result = caseDimension(frame);
				if (result == null) result = caseLocation(frame);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewPackage.VIEWPORT: {
				Viewport viewport = (Viewport)theEObject;
				T result = caseViewport(viewport);
				if (result == null) result = caseDimension(viewport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
