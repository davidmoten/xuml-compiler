 ...
 * </copyright>
 *
 * $Id: ViewPackageImpl.java,v 1.2 2008/06/23 06:17:50 dxm Exp $
 */
package view.impl;
...
public class ViewPackageImpl extends EPackageImpl implements ViewPackage {
	 ...
	 * @generated
	 */
	public EReference getElement_FixedTo() {
	 ...
	 * @generated
	 */
	public EReference getView_Frame() {
	 ...
	 * @generated
	 */
	public EReference getView_Viewport() {
	...
	public void createPackageContents() {
		...
		createEReference(elementEClass, ELEMENT__FIXED_TO);
		...
		createEReference(viewEClass, VIEW__FRAME);
		createEReference(viewEClass, VIEW__VIEWPORT);
	...
	public void initializePackageContents() {
		...
		elementEClass.getESuperTypes().add(this.getLocation());
		frameEClass.getESuperTypes().add(this.getDimension());
		frameEClass.getESuperTypes().add(this.getLocation());
		viewportEClass.getESuperTypes().add(this.getDimension());
		...
		initEReference(getElement_FixedTo(), this.getLocation(), null, "fixedTo", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getElement_Dimension(), this.getDimension(), null, "dimension", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(locationEClass, Location.class, "Location", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLocation_X(), ecorePackage.getEInt(), "x", null, 1, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLocation_Y(), ecorePackage.getEInt(), "y", null, 1, 1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(dimensionEClass, Dimension.class, "Dimension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDimension_Width(), ecorePackage.getEIntegerObject(), "width", null, 0, 1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDimension_Height(), ecorePackage.getEIntegerObject(), "height", null, 0, 1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getView_Frame(), this.getFrame(), null, "frame", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getView_Viewport(), this.getViewport(), null, "viewport", null, 1, 1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getView_Element(), this.getElement(), null, "element", null, 0, -1, View.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
