 ...
 * </copyright>
 *
 * $Id: CollaborationSwitch.java,v 1.4 2008/06/11 07:28:48 dxm Exp $
 */
...
public class CollaborationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CollaborationPackage.OBJECT: {
				model.collaboration.Object object = (model.collaboration.Object)theEObject;
				T result = caseObject(object);
				if (result == null) result = caseCollaborator(object);
				if (result == null) result = caseNamed(object);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CollaborationPackage.COLLABORATOR: {
				Collaborator collaborator = (Collaborator)theEObject;
				T result = caseCollaborator(collaborator);
				if (result == null) result = caseNamed(collaborator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CollaborationPackage.COMMUNICATION: {
				Communication communication = (Communication)theEObject;
				T result = caseCommunication(communication);
				if (result == null) result = caseNamed(communication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseObject(model.collaboration.Object object) {
		return null;
	}
