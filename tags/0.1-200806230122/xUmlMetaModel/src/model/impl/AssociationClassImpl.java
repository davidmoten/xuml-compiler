 ...
 * </copyright>
 *
 * $Id: AssociationClassImpl.java,v 1.4 2008/06/11 07:28:44 dxm Exp $
 */
package model.impl;
...
public class AssociationClassImpl extends ClassImpl implements AssociationClass {
		...
		if (association != null && association.eIsProxy()) {
			...
			if (association != oldAssociation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.ASSOCIATION_CLASS__ASSOCIATION, oldAssociation, association));
			}
		}
		return association;
	}
	...
	public void setAssociation(Association newAssociation) {
		if (newAssociation != association) {
			...
			if (association != null)
				msgs = ((InternalEObject)association).eInverseRemove(this, ModelPackage.ASSOCIATION__ASSOCIATION_CLASS, Association.class, msgs);
			if (newAssociation != null)
				msgs = ((InternalEObject)newAssociation).eInverseAdd(this, ModelPackage.ASSOCIATION__ASSOCIATION_CLASS, Association.class, msgs);
			msgs = basicSetAssociation(newAssociation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ASSOCIATION_CLASS__ASSOCIATION, newAssociation, newAssociation));
	}
