...
public class CashbookSystem extends SystemBase {
	...
	private void initialize() {
		...
		// Class manualEntry = createClass(pkg, "ManualEntry",
		// "a CashbookEntry created by the customer in leiu of an AutoGeneratedEntry");
		// Class autoGeneratedEntry = createClass(pkg, "AutoGeneratedEntry",
		// "a CashbookEntry created automatically as a result of a psoting rule");
		//
		//		
		// TODO: not sure how link ManualEntry and AutoGeneratedEntry into R13
		// with CashbookEntry as superclass
